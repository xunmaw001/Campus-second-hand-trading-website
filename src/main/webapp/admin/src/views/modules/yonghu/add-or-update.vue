<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="微信" prop="weixin">
          <el-input v-model="ruleForm.weixin" 
              placeholder="微信" clearable  :readonly="ro.weixin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="微信" prop="weixin">
              <el-input v-model="ruleForm.weixin" 
                placeholder="微信" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
