<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卖家学校" prop="maijiaxuexiao">
          <el-input v-model="ruleForm.maijiaxuexiao" 
              placeholder="卖家学校" clearable  :readonly="ro.maijiaxuexiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卖家学校" prop="maijiaxuexiao">
              <el-input v-model="ruleForm.maijiaxuexiao" 
                placeholder="卖家学校" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="卖家性别" prop="maijiaxingbie">
        ...
        <div v-else>
          <el-form-item class="input" label="卖家性别" prop="maijiaxingbie">
	      <el-input v-model="ruleForm.maijiaxingbie"
                placeholder="卖家性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卖家QQ" prop="maijiaQQ">
          <el-input v-model="ruleForm.maijiaQQ" 
              placeholder="卖家QQ" clearable  :readonly="ro.maijiaQQ"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卖家QQ" prop="maijiaQQ">
              <el-input v-model="ruleForm.maijiaQQ" 
                placeholder="卖家QQ" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卖家微信" prop="maijiaweixin">
          <el-input v-model="ruleForm.maijiaweixin" 
              placeholder="卖家微信" clearable  :readonly="ro.maijiaweixin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卖家微信" prop="maijiaweixin">
              <el-input v-model="ruleForm.maijiaweixin" 
                placeholder="卖家微信" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.maijiaxingming = true;
          ...
          if(o=='maijiaxuexiao'){
            this.ruleForm.maijiaxuexiao = obj[o];
	    this.ro.maijiaxuexiao = true;
            continue;
          }
          if(o=='maijiaxingbie'){
            this.ruleForm.maijiaxingbie = obj[o];
	    this.ro.maijiaxingbie = true;
            continue;
          }
          if(o=='maijiashouji'){
	    ...
	    this.ro.maijiashouji = true;
          ...
          if(o=='maijiaQQ'){
            this.ruleForm.maijiaQQ = obj[o];
	    this.ro.maijiaQQ = true;
            continue;
          }
          if(o=='maijiaweixin'){
            this.ruleForm.maijiaweixin = obj[o];
	    this.ro.maijiaweixin = true;
            continue;
          }
          if(o=='touxiang'){
