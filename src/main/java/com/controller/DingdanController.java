...
public class DingdanController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanEntity dingdan, 
		...
		if(tableName.equals("maijia")) {
			dingdan.setMaijiazhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DingdanEntity dingdan, 
		HttpServletRequest request){
    ...
    public R info(@PathVariable("id") Long id){
		...
		dingdan.setClicknum(dingdan.getClicknum()+1);
